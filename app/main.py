...
if __name__ == "__main__":
    ...
    repository = QdrantRepository(host="localhost", port=6333, collection_name="documents_2")
    prompt_generator = PromptGenerator()
    ollama_service = OllamaService(api_url="http://localhost:11434/api/generate")
